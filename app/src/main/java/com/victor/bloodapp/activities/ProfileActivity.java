package com.victor.bloodapp.activities;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private Spinner gender, bloodgroup, county;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        county = findViewById(R.id.inputDivision);
            ...
            Profile.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (userData != null) {
                        ...
                        county.setSelection(userData.getCounty());
                        Query donor = donor_ref.child(county.getSelectedItem().toString())
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int County = county.getSelectedItemPosition();
                final String blood = bloodgroup.getSelectedItem().toString();
                final String div   = county.getSelectedItem().toString();
//verification of registration fields below
                try {
                                        ...
                                        .addOnCompleteListener(ProfileActivity.this, new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                ...
                                                if (!task.isSuccessful()) {
                                                    ...
                                                    db_ref.child(id).child("County").setValue(County);
