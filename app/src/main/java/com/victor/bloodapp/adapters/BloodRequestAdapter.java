package com.victor.bloodapp.adapters;
...
import com.victor.bloodapp.viewmodels.CustomUserData;

import java.util.List;

//adapter to create/display your posts
...
// alternating background colors
        ...
        postHolder.Address.setText("From: "+customUserData.getAddress()+", "+customUserData.getCounty());
